...
assert(values.agent_status == "idle", "agent status should start idle")
env.onIpc("agent-status", "running")
assert(values.agent_status == "running", "agent status IPC should publish known states")
env.onIpc("agent-status", "broken")
assert(values.agent_status == "running", "agent status IPC should ignore unknown states")
env.onIpc("refresh")
